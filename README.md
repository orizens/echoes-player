...
## Tech Review
it's a sample web app built with Angular JS v2.x, Bootstrap v3.x, Typescript, ES2015 and SystemJs with Loader Spec.

## What's Inside
Currently, I'm using AngularClass angular2 webpack starter repo. It's a quite robust starter which includes inside everything needed to experiment with angular2.
